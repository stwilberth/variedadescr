    ...
    <div class="container">
        ...
        <div class="row">
                    ...
                    <div class="col-12 pl-4 pr-4">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <span class="font-weight-bold">Marca:</span> {{$producto->marca->nombre}}.
                                <br>
                                <span class="font-weight-bold">Modelo:</span> {{$producto->modelo}}.
                                <br>
                                <span class="font-weight-bold">Género:</span> {{ $producto->generoTexto }}.
                                <br>
            ...
            <x-slider-productos 
                ...
                :catalogo-id="$producto->catalogo"
                slider-id="el_slider"
                :excluir-id="$producto->id"
